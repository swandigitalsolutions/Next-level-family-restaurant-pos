(async function initStaff() {
  ...
  function roleTag(role) {
    return `<span class="tag role-${role}">${ROLE_LABELS[role] || role}</span>`;
  }
  ...
  function renderStats() {
    ...
    document.getElementById("statCashiers").textContent = STAFF.filter(s => s.role === "manager" || s.role === "staff").length;
  }
